...
.DESCRIPTION
    This script aims to harden Windows Server 2019 VM baseline policies using Desired State Configurations (DSC) for CIS Benchmark Windows Server 2019 Version 1.0.0.
.CREDIT
    Baseline code from ZScaler (https://cloudneeti.github.io/Cloudneeti_SaaS_Docs/remediation/osBaseline/win19QuickWins/)
    Use in compliance with ZCSPM Copyright terms, and express permission to use provided withing the copyright
    Modified for Cigna specific hardening standards
